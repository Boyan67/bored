...
function ActivityCardLarge({category, title, people, price, accessibility}) {
    ...
    return (
        <View style={[globalStyles.card, styles.container, {backgroundColor:colors.card}]}>
            ...
            <Text style={[styles.title, globalStyles.text, {color: colors.text}]}>{title}</Text>

            <View style={styles.detailsContainer}>
                <View style={styles.details}>
                    <Image source={Images.icons.people} style={styles.categoryIcon}/>
                    <Text style={[globalStyles.text, {color: colors.text}]}>{people}</Text>
                </View>
                <View style={styles.details}>
                    <Image source={Images.icons.price} style={styles.categoryIcon}/>
                    <Text style={[globalStyles.text, {color: colors.text}]}>{price*100}%</Text>
                </View>
                <View style={styles.details}>
                    <Image source={Images.icons.averageGray} style={styles.categoryIcon}/>
                    <Text style={[globalStyles.text, {color: colors.text}]}>{accessibility*100}%</Text>
                </View>
            </View>
